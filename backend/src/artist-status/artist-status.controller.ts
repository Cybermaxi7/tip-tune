...
import { ArtistOwnerGuard } from "../artists/guards/artist-owner.guard";
import {
  CurrentUser,
  CurrentUserData,
...
export class ArtistStatusController {
   ...
   */
  @Put(":artistId/status")
  @UseGuards(JwtAuthGuard, ArtistOwnerGuard)
  ...
  @ApiResponse({
    status: 403,
    description: "Forbidden - Must own artist profile or have admin privileges",
  })
